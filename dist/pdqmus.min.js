...
pdqmus.AsynchRequest.prototype.loadJson=function(a){var b=this;this.xmlHttp.overrideMimeType(pdqmus.XmlHttpRequest.CONTENT_TYPE_JSON);this.xmlHttp.open(this.method,a,true);this.xmlHttp.setRequestHeader(pdqmus.XmlHttpRequest.HEADER_ACCEPT,pdqmus.XmlHttpRequest.CONTENT_TYPE_JSON);this.xmlHttp.setRequestHeader(pdqmus.XmlHttpRequest.HEADER_REQUESTED_WITH,pdqmus.XmlHttpRequest.REQUESTED_WITH_TYPE);this.xmlHttp.onreadystatechange=function(){if(b.xmlHttp.readyState==pdqmus.XmlHttpRequest.READYSTATE_COMPLETE){b.string=
b.xmlHttp.responseText;try{if(b.parseJsonResponse)b.data=JSON.parse(b.string);if(pdqmus.XmlHttpRequest.SUCCESS_STATUSES.indexOf(b.xmlHttp.status)>=0){if(b.loadedCallback!=null)b.data?b.loadedCallback(b.data):b.loadedCallback(b.string)}else b.errorCallback!=null&&b.errorCallback()}catch(c){b.errorCallback!=null&&b.errorCallback({error:c,response:b.xmlHttp.responseText,status:b.xmlHttp.status})}}};if(this.requestObj){this.xmlHttp.setRequestHeader(pdqmus.XmlHttpRequest.HEADER_CONTENT_TYPE,pdqmus.XmlHttpRequest.CONTENT_TYPE_JSON);
this.requestData=JSON.stringify(this.requestObj)}this.xmlHttp.send(this.requestData)};
pdqmus.AsynchRequest.prototype.loadXml=function(a){var b=this;this.xmlHttp.overrideMimeType(pdqmus.XmlHttpRequest.CONTENT_TYPE_XML);this.xmlHttp.open(this.method,a,true);this.xmlHttp.setRequestHeader(pdqmus.XmlHttpRequest.HEADER_ACCEPT,pdqmus.XmlHttpRequest.CONTENT_TYPE_XML);this.xmlHttp.setRequestHeader(pdqmus.XmlHttpRequest.HEADER_REQUESTED_WITH,pdqmus.XmlHttpRequest.REQUESTED_WITH_TYPE);this.xmlHttp.onreadystatechange=function(){if(b.xmlHttp.readyState==pdqmus.XmlHttpRequest.READYSTATE_COMPLETE){b.string=
b.xmlHttp.responseText.replace('<?xml version="1.0" encoding="UTF-8"?>',"");try{b.data=b.xmlHttp.responseXML;if(XmlHttpRequest.SUCCESS_STATUSES.indexOf(b.xmlHttp.status)>=0){if(b.loadedCallback!=null)b.data?b.loadedCallback(b.data):b.loadedCallback(b.string)}else b.errorCallback!=null&&b.errorCallback()}catch(c){b.errorCallback!=null&&b.errorCallback({error:c,response:b.xmlHttp.responseText,status:b.xmlHttp.status})}}};this.xmlHttp.send(this.requestData)};
pdqmus.AsynchRequest.prototype.cancelCallback=function(){this.loadedCallback=null};pdqmus.AudioSequence=function(a,b,c,f){function p(){if(window.Worker){s=new Worker(x+"/wave_render_worker.js");s.onmessage=function(l){j.push(l.data)};s.onerror=function(l){throw l;}}}function r(l){pdqmus.Sample.createFromUrl(l.audioDataUrl).play()}function t(){var l=((new Date).getTime()-q)/1E3;if(j.length>0&&j[0].notes[0].onset<=l-pdqmus.AudioSequence.BUFFER_DELAY){if(!B){v&&v();B=true}if(j.length<=1&&D)C=true;setTimeout(r,1,j.shift())}if(m.length>0&&m[0].onset<=l+A){l=m.shift();for(var F=[l],E=
1;E<m.length;E++)if(m[E].onset==l.onset)F.push(m.shift());else if(m[E].onset>l.onset)break;l=new pdqmus.RenderWaveMessage([l],z,g);s.postMessage(l)}if(m.length<=0)D=true;if(C)y&&y();else o=setTimeout(t,w)}var w=10,o,q,j=[],A=2,u=a.clone(),m,z=b,g=c||null,C=false,B=false,D=false,d=new pdqmus.Wave,h=true,v=null,y=null,x=f||pdqmus.AudioSequence.DEFAULT_WEBWORKER_INCLUDE_PATH,k=this,s=null;this.drawWaveform=function(){return k.getAggregateWave().draw()};this.getDataUrl=function(){return k.getAggregateWave().getDataUrl()};
this.getAggregateWave=function(){if(h){for(var l=0;l<u.length;l++){var F=u[l];d.render(pdqmus.Note.frequencyFromMidiNote(F.noteNum),F.duration,pdqmus.Note.midiVelocityToAmplitude(F.velocity),b);c&&d.envelope(g)}h=false}return d};this.pause=function(){throw"unimplemented";};this.stop=function(){s&&s.terminate();clearTimeout(o);y&&y()};this.play=function(l){if(l){s||p();q=new Date;m=u.clone();m.sort(pdqmus.Notation.sortByOnset);setTimeout(t,1)}else pdqmus.Sample.createFromUrl(k.getDataUrl()).play()};
...
Base64.encode=function(a,b){var c,f,p,r,t=[],w="",o,q,j=Base64.code;q=(typeof b=="undefined"?false:b)?Utf8.encode(a):a;o=q.length%3;if(o>0)for(;o++<3;){w+="=";q+="\u0000"}for(o=0;o<q.length;o+=3){c=q.charCodeAt(o);f=q.charCodeAt(o+1);p=q.charCodeAt(o+2);r=c<<16|f<<8|p;c=r>>18&63;f=r>>12&63;p=r>>6&63;r=r&63;t[o/3]=j.charAt(c)+j.charAt(f)+j.charAt(p)+j.charAt(r)}t=t.join("");return t=t.slice(0,t.length-w.length)+w};
Base64.decode=function(a,b){b=typeof b=="undefined"?false:b;var c,f,p,r,t,w=[],o,q=Base64.code;o=b?Utf8.decode(a):a;for(var j=0;j<o.length;j+=4){c=q.indexOf(o.charAt(j));f=q.indexOf(o.charAt(j+1));r=q.indexOf(o.charAt(j+2));t=q.indexOf(o.charAt(j+3));p=c<<18|f<<12|r<<6|t;c=p>>>16&255;f=p>>>8&255;p=p&255;w[j/4]=String.fromCharCode(c,f,p);if(t==64)w[j/4]=String.fromCharCode(c,f);if(r==64)w[j/4]=String.fromCharCode(c)}r=w.join("");return b?Utf8.decode(r):r};var Utf8={};
...
"Pad 7 (halo)","Pad 8 (sweep)","FX 1 (rain)","FX 2 (soundtrack)","FX 3 (crystal)","FX 4 (atmosphere)","FX 5 (brightness)","FX 6 (goblins)","FX 7 (echoes)","FX 8 (sci-fi)","Sitar","Banjo","Shamisen","Koto","Kalimba","Bag pipe","Fiddle","Shanai","Tinkle Bell","Agogo","Steel Drums","Woodblock","Taiko Drum","Melodic Tom","Synth Drum","Reverse Cymbal","Guitar Fret Noise","Breath Noise","Seashore","Bird Tweet","Telephone Ring","Helicopter","Applause","Gunshot"];pdqmus.KeySignature=function(a,b,c){this.onset=a;this.fifths=b;this.mode=c;this.duration=0};pdqmus.KeySignature.prototype=new pdqmus.Notation;pdqmus.KeySignature.prototype.clone=function(){return new pdqmus.KeySignature(this.onset,this.fifths,this.mode,this.onsetMetric)};pdqmus.KeySignature.MODE_MAJOR="major";pdqmus.KeySignature.MODE_MINOR="minor";pdqmus.Midi=function(a,b){function c(o){for(var q=0,j=0,A="",u=0;u<o.length;u++){j=Math.round(o[u].onset*p/60*f);A+=pdqmus.Util.strFromVariableInt(j-q);A+=o[u].write();q=j}return A}var f=480,p=b||120,r="",t="",w=a||1;this.addTrack=function(o,q,j){q>=0||(q=0);j>=0||(q=0);j=pdqmus.Util.strFromByte(0)+pdqmus.Util.strFromByte(192+q)+pdqmus.Util.strFromByte(j)+pdqmus.Util.strFromByte(0)+pdqmus.Util.strFromByte(255)+pdqmus.Util.strFromByte(4)+pdqmus.Util.strFromByte(25)+"Contrabass Ukulelephonium";for(var A=
[],u=0;u<o.length;u++){var m=o[u];A.push(new pdqmus.MidiNote(u,m.onset,9,q,m.noteNum,m.velocity));A.push(new pdqmus.MidiNote(u,m.onset+m.duration,8,q,m.noteNum,0))}A.sort(pdqmus.Notation.sortByOnset);j+=c(A)+pdqmus.Util.strFromVariableInt(Math.round(f/10))+pdqmus.Util.strFromByte(255)+pdqmus.Util.strFromByte(47)+pdqmus.Util.strFromByte(0);t+="MTrk"+pdqmus.Util.strFromDword(j.length,pdqmus.Util.BIG_ENDIAN)+j};this.getDataUrl=function(o){return o?"data:"+pdqmus.Midi.MIME_TYPE+";base64,"+Base64.encode(r+
t):"data:"+pdqmus.Midi.MIME_TYPE+";base64,"+btoa(r+t)};r="MThd"+pdqmus.Util.strFromDword(6,pdqmus.Util.BIG_ENDIAN)+pdqmus.Util.strFromWord(1,pdqmus.Util.BIG_ENDIAN)+pdqmus.Util.strFromWord(w+1,pdqmus.Util.BIG_ENDIAN)+pdqmus.Util.strFromWord(f,pdqmus.Util.BIG_ENDIAN);(function(){var o=Math.round(6E7/p);o=pdqmus.Util.strFromByte(0)+pdqmus.Util.strFromByte(255)+pdqmus.Util.strFromByte(81)+pdqmus.Util.strFromByte(3)+pdqmus.Util.strFromByte(o>>16)+pdqmus.Util.strFromByte(o>>8)+pdqmus.Util.strFromByte(o)+
pdqmus.Util.strFromByte(0)+pdqmus.Util.strFromByte(255)+pdqmus.Util.strFromByte(3)+pdqmus.Util.strFromByte(26)+"MIDI Created by Javascript"+pdqmus.Util.strFromByte(0)+pdqmus.Util.strFromByte(255)+pdqmus.Util.strFromByte(2)+pdqmus.Util.strFromByte(42)+"Copyleft, Music Hack Day Boston 2010 rules";messages=[];messages.push(new pdqmus.MidiKeySignature(0,0,0));messages.push(new pdqmus.MidiTimeSignature(1,0,4,4));o+=c(messages)+pdqmus.Util.strFromByte(0)+pdqmus.Util.strFromByte(255)+pdqmus.Util.strFromByte(47)+
pdqmus.Util.strFromByte(0);t+="MTrk"+pdqmus.Util.strFromDword(o.length,pdqmus.Util.BIG_ENDIAN)+o})()};pdqmus.Midi.prototype.play=function(){pdqmus.MidiSound.createFromUrl(this.getDataUrl()).play()};pdqmus.MidiMessage=function(a,b,c){this.index=a;this.onset=b;this.statusCode=c};pdqmus.MidiNote=function(a,b,c,f,p,r){this.index=a;this.onset=b;this.statusCode=c;this.channel=f;this.noteNum=p;this.velocity=r};pdqmus.MidiNote.prototype=new pdqmus.MidiMessage;
...
pdqmus.MidiSound.prototype.destroy=function(){this.domRef.parentNode.removeChild(this.domRef);this.domRef=null};pdqmus.MidiSound.prototype.clone=function(){return pdqmus.MidiSound.createFromUrl(this.url)};pdqmus.MidiSound.createFromUrl=function(a){var b=new pdqmus.MidiSound;b.domRef.src=a;b.domRef.id=pdqmus.Util.guid();return b};pdqmus.Note=function(a,b,c,f,p,r,t){this.onset=a;this.duration=b;this.noteNum=c;this.velocity=f||60;this.onsetMetric=r;this.durationMetric=t;this.isRest=p||false};pdqmus.Note.prototype=new pdqmus.Notation;pdqmus.Note.prototype.clone=function(){return new pdqmus.Note(this.onset,this.duration,this.noteNum,this.velocity,this.isRest)};pdqmus.Note.midiVelocityToAmplitude=function(a){return 1/127*a};pdqmus.Note.midiNoteFromFrequency=function(a){return 12*Math.log2(a/440)+69};
pdqmus.Note.frequencyFromMidiNote=function(a){return pdqmus.Note.CONCERT_A_FREQUENCY/32*Math.pow(2,(a-9)/12)};pdqmus.Note.CONCERT_A_FREQUENCY=440;pdqmus.Note.randomNotes=function(a,b){for(var c=[],f=0,p=0;p<a;p++){var r=Math.random(),t=new pdqmus.Note(f,r*0.9,Math.floor(Math.random()*100)+10,b?Math.floor(Math.random()*40)+10:Math.floor(Math.random()*50)+67);f+=r;c.push(t)}return c};
pdqmus.Note.chromaticSequence=function(a,b,c){var f=0,p=[];for(a=a;a<=b;a++){var r=new pdqmus.Note(f,c,a,60);p.push(r);f+=c}return p};pdqmus.Note.DEFAULT_VELOCITY=60;
...
pdqmus.Util.LITTLE_ENDIAN="littleEndian";pdqmus.Util.NEWLINE="\n";Object.prototype.clone=function(){var a=this instanceof Array?[]:{};for(i in this)if(i!="clone")a[i]=this[i]&&typeof this[i]=="object"?this[i].clone():this[i];return a};pdqmus.Util.saveDataUrl=function(a){a=window.open(a,"Save File");alert("save with Save As...");a.focus();return a};pdqmus.Util.dataUrlFromMusicXml=function(a){return"data:text/xml;base64,"+btoa(a)};
